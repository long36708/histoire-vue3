...
[compare changes](https://github.com/Akryum/histoire/compare/v1.0.0-alpha.4...v2.1.0)
...
- **vite:** Add IconifyProviders configuration in HTML templates ([71dc263](https://github.com/Akryum/histoire/commit/71dc263))
- 为 vue2 插件添加 TypeScript 类型定义支持 ([f49ffd9](https://github.com/Akryum/histoire/commit/f49ffd9))
...
- 修复打包后目录结构错误 ([f3c4c68](https://github.com/Akryum/histoire/commit/f3c4c68))
...
- **markdown:** Update shiki highlighter implementation ([c825e85](https://github.com/Akryum/histoire/commit/c825e85))
...
- Vite8迁移 ([69a7d7e](https://github.com/Akryum/histoire/commit/69a7d7e))
...
[compare changes](https://github.com/Akryum/histoire/compare/v1.0.0-alpha.4...v2.0.2)
...
[compare changes](https://github.com/Akryum/histoire/compare/v1.0.0-alpha.4...v2.0.1)
